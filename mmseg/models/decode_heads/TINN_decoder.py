...
class TINNHead(BaseDecodeHead):
    """
    SegFormer: Simple and Efficient Design for Semantic Segmentation with Transformers
    """
    def __init__(self, feature_strides, **kwargs):
        super(TINNHead, self).__init__(input_transform='multiple_select', **kwargs)
    ...
    def forward(self, inputs):
        ...
        _c5 = resize(_c5, size=c1.size()[2:],mode='bilinear',align_corners=False)
